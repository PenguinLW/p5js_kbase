...
function preload() {
	...
	lis = ""+
		...
		"По устоявшимся традициям, в теге \"head\" указаны теги \"script\", которые отвечают за подключение к web-странице файлов исходного кода javascript (имеют расширение .js) - как собственных сценариев, так и js-библиотек.\n"+
